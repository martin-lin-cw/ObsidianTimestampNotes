import { Editor, MarkdownView, Plugin, Modal, App, TFile } from "obsidian";
import ReactPlayer from "react-player/lazy";

import { VideoView, VIDEO_VIEW } from "./view/VideoView";
import {
	TimestampPluginSettings,
		...
		this.addCommand({
			...
			editorCallback: (editor: Editor, view: MarkdownView) => {
				...
				const leadingZero = (num: number) =>
					num < 10 ? "0" + num.toFixed(0) : num.toFixed(0);
